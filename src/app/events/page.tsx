      ...
      <div className="page-section__inner space-y-12">
        <div className="space-y-4 text-center">
          ...
          <p className="mx-auto max-w-3xl text-base text-white/70">
            Join us for evenings of remembrance, community, and scholarship carefully curated to echo the ambience of Rahmaniyyah&apos;s assemblies.
          </p>
        </div>
            ...
            <div key={event.id} className="glass-panel overflow-hidden p-0">
              <div className="grid gap-0 md:grid-cols-[1.1fr_1.2fr]">
                <div className="relative h-full min-h-[240px]">
                  ...
                  <p className="absolute bottom-4 left-4 text-xs uppercase tracking-[0.4em] text-white/60">Rahmaniyyah Style</p>
                </div>
