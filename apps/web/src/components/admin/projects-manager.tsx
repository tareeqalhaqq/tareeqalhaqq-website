  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Project details are now available on the homepage projects section.",
      });
    ...
    <div className="glass-panel space-y-6 p-8 text-white">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-semibold">
            Manage landing and projects page cards
          </h2>
          <p className="text-sm text-white/70">
            {adminName ? `Hi ${adminName},` : "Hi there,"} update project cards
            shown on the homepage projects section.
          </p>
        </div>
            ...
            <DialogContent className="max-w-2xl bg-slate-950 text-white">
              <DialogHeader>
                ...
                <DialogDescription className="text-white/60">
                  Published projects appear on the landing page projects
                  section.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        handleChange("href", event.target.value)
                      }
                      placeholder="/"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        handleChange("display_order", event.target.value)
                      }
                      placeholder="0"
                    />
                  </div>
      ...
      {errorMessage && (
        <div className="rounded-lg border border-amber-400/30 bg-amber-400/10 px-4 py-3 text-sm text-amber-100">
          Could not read the <code>projects</code> table yet ({errorMessage}).
          Create a <code>projects</code> table in Supabase with columns matching
          this manager to enable full editing.
        </div>
      )}
              ...
              projects.map((project) => (
                <TableRow key={project.id}>
                  <TableCell>
                    ...
                    <p className="line-clamp-2 max-w-sm text-xs text-white/55">
                      {project.description}
                    </p>
                  </TableCell>
                        ...
                        <AlertDialogContent className="bg-slate-950 text-white">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="text-white/65">
                              ...
                              {deleteTarget?.title ?? project.title}”.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
